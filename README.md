...
Explicitly setting types. It's nice to know what data-type you're working with. Prevents errors.

Describe a life-cycle event in React?

Lifecycle events are these little hooks that the API consumer can use to do stuff at specific points during a component's... lifecycle.

Explain the details of a Higher Order Component?
A function that returns another function. The point is to customize the function being returned.

What are three different ways to style components in React?
Inline styles. CSS preprocessors. CSS Modules.

Explain some of the benefits of each.

-   Inline styles are okay for smaller projects.
-   Styled-components are... interesting.
-   CSS preprocessors are wonderful. Unless you choose Less over Sass. But you wouldn't do that while sober.
-   CSS Modules are cool if you're afraid your naming-convention game is so sloppy you'll get collisions all the time.
